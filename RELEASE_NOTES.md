# CDC 2.1.3 - Three-second boot lighting delay

Assets:

- `Pico_SRGB_CDC_v2_1_3_RP2040.uf2`: Raspberry Pi Pico firmware.
...
Changes: three seconds of darkness before full-brightness progressive boot white;
host control can take over immediately during this delay. DTR-independent CDC handshake
